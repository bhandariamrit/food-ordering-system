  ...
  return (
    <section className="mt-14 max-w-md mx-auto">
      ...
      <button
        ...
        className="flex gap-4 justify-center border p-3 rounded-xl mx-auto hover:bg-primary duration-150 ease-in-out"
      >
      ...
      <p className="text-center mt-6 text-lg font-poppins font-bold">
        ...
        <Link
          href={"/login"}
          className="underline text-warning hover:text-primary cursor-pointer"
        >
          Login here &raquo;
        </Link>
      </p>
